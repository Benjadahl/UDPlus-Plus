...
const colorElements ={
		...
		lessonFill:{cssSel:"svg .GC0H5P4BPX rect", cssAttr:["fill"], styleRule: true, isImportant: true, specialBorder: false},
		lessonStroke:{cssSel:"svg .GC0H5P4BPX rect", cssAttr:["stroke"], styleRule: true, isImportant: true, specialBorder: false},
		...
		tableBackground:{cssSel:".GC0H5P4BI- table.GC0H5P4BI- td", cssAttr:["background"], styleRule: true, isImportant: true, specialBorder: false},
