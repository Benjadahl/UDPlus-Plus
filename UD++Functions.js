...
const colorElements ={
		...
		tableTopActive:{cssSel:".GNK2GVDDO- th.GNK2GVDDF-", cssAttr:["background-color", "border-top-color"], styleRule: true, isImportant: true, specialBorder: false},
		...
		tableLeftSide:{cssSel:".GNK2GVDDP- table", cssAttr:["background"], styleRule: true, isImportant: true, specialBorder: false},
		...
		commentText:{cssSel:".K1CYATD-r-f", cssAttr:["color"], styleRule: true, isImportant: true, specialBorder: false},
		...
		assignmentSetting:{cssSel: ".GI4UTTLBF", cssAttr:["background-color"], styleRule: true, isImportant: true, specialBorder: false},
